...
public class RoleController {
    ...
    public String edit(@PathVariable(name = "roleId") final UUID roleId, final Model model) {
        model.addAttribute("role", roleService.get(roleId));
        return "role/edit";
    }

    @PostMapping("/edit/{roleId}")
    public String edit(@PathVariable(name = "roleId") final UUID roleId,
    ...
    public String delete(@PathVariable(name = "roleId") final UUID roleId,
            final RedirectAttributes redirectAttributes) {
